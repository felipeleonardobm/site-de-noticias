...
if($rating) {
    if(!$rating[0]['rating']) {
        ...
        echo 'dislike desativado';
    } else {
        $dataBase->query("UPDATE ratings SET rating = 0 WHERE (id_user = ".$user[0]['id']." AND id_post = ".$n.")");
        ...
        echo 'like desativado e dislike ativado';
    }
